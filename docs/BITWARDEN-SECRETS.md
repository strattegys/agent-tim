...
**Stable baseline vs dev play:** Pull Bitwarden into **`web/.env.local`** (or **`site/.env.local`**) and keep **`web/.env.development.local`** for LOCALDEV (**port 3010**, Auth URLs) — see **`COMMAND-CENTRAL/docs/LOCAL-ENV-LAYERS.md`**.
